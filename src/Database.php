...
namespace Illum\Database;

use Illum\Database\SQL\InsertStatement;
use Illum\Database\SQL\Query as QueryCommand;
use Illum\Database\SQL\Insert as InsertCommand;
use Illum\Database\SQL\Update as UpdateCommand;
