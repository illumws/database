...
use Illum\Database\Schema\CreateTable;
use Illum\Database\Schema\AlterTable;

class Schema
{
    /** @var    \Illum\Database\Connection   Connection. */
     ...
     * Constructor
     *
     * @param   \Illum\Database\Connection $connection Connection.
     */
