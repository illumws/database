...
namespace Illum\Database\ORM\Core;

use Illuminate\Support\Collection;
use Illum\Database\Connection;
use Illum\Database\SQL\{
    Delete, SQLStatement, Update
};
use Illum\Database\ORM\{
    EntityManager
};
use Illum\Database\ORM\Traits\AggregateTrait;
...
class EntityQuery extends Query
{
     ...
     * @return Collection
     */
    public function findAll(...$ids): Collection
    {
        if (is_array($ids[0])) {
    ...
    /**
     * @param array $columns
     * @return \Illum\Database\ResultSet;
     */
