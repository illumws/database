...
use Illum\Database\ORM\Core\EntityQuery;
use Illum\Database\ORM\EntityManager;
use Illum\Database\{
    Database, Connection,
    Schema\CreateTable
};
...
{
    return \Illum\Database\Test\entityManager()->query($class);
}
...
\Illum\Database\Test\entityManager(new EntityManager($connection));
