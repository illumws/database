...
namespace Illum\Database\Test\Entities;

use Illuminate\Support\Collection;
use Illum\Database\ORM\Core\DataMapper;
use Illum\Database\ORM\IDataMapper;
use Illum\Database\ORM\IEntityMapper;
use Illum\Database\ORM\Core\Query;
use Illum\Database\ORM\Entity;
use Illum\Database\ORM\IMappableEntity;
...
class User extends Entity implements IMappableEntity
{
    ...
    public function publishedArticles(bool $prefix = false): Collection
    {
    ...
    public function unpublishedArticles(bool $prefix = false): Collection
    {
